...
const Card = () => {
  return (
    <div className="h-104 w-63 bg-zinc-900 rounded-4xl p-4 flex flex-col justify-between">
      {/* imgCover */}
      <div>
        <img className="w-55 rounded-3xl" src="cover.jpg" alt="" />
      </div>
      {/* text and title */}
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="text-zinc-400 flex justify-between tracking-wider text-[11px]">
            <p>2:11</p>
            <p>3:35</p>
          </div>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="flex gap-6">
            ...
            <FaPause size={34} className="text-zinc-200" />
            <IconPlayerTrackNextFilled size={34} className="text-zinc-200" />
          </div>
        </div>
        {/* volume */}
        <div className="relative pb-4 flex items-center justify-center">
